...
const { features, presets, isFeatureEnabled, getEnabledFeatures } = require('../../config/features');
...
function generatePackageJson() {
  ...
  try {
    const { generatePackageJson: genPkg, generateScripts } = require('../../config/features');
